...
## This was created by Radha Mahalingam (7-11-19)

## Data used for the analysis - NY Citibike data from Oct 2018 to May 2019.  

## These 8 csv files have been cancatenated using the following command

## cat *.csv > 201810-201905-citibike-tripdata.csv
